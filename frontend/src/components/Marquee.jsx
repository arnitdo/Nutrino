export default function Marquee({ items }) {
    return (
      <div className="relative flex w-screen overflow-x-hidden border-b-2 border-t-2 border-white bg-black font-bold">
        <div className="animate-marquee whitespace-nowrap py-8">
          {items.map((item, idx) => {
            return (
              <span key={idx} className="mx-4 text-4xl text-white">
                {item}
              </span>
            )
          })}
