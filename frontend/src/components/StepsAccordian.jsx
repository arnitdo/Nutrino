...
export default function StepsAccordion({ question, children }) {
  ...
  return (
    <div className="w-full rounded-md border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      ...
      <div
        ...
        className="overflow-hidden rounded-b-[5px] h-fit w-full  bg-white font-bold transition-[height] ease-in-out"
      >
        {children}
      </div>
    </div>
